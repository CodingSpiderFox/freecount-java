...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './project-member-role.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROJECTMEMBERROLE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_PROJECTMEMBERROLES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_PROJECTMEMBERROLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PROJECTMEMBERROLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PROJECTMEMBERROLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PROJECTMEMBERROLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PROJECTMEMBERROLE actions', async () => {
      const expectedActions = [
        {
