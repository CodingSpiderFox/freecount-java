...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BILLPOSITION_LIST actions', async () => {
    ...
    it('dispatches SEARCH_BILLPOSITIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_BILLPOSITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BILLPOSITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BILLPOSITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BILLPOSITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BILLPOSITION actions', async () => {
      const expectedActions = [
        {
