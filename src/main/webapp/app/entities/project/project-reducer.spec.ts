...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROJECT_LIST actions', async () => {
    ...
    it('dispatches SEARCH_PROJECTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_PROJECT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PROJECT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PROJECT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PROJECT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PROJECT actions', async () => {
      const expectedActions = [
        {
