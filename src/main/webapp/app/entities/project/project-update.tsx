...
export const ProjectUpdate = (props: RouteComponentProps<{ id: string }>) => {
  ...
  const defaultValues = () =>
    isNew
      ...
      : {
          ...projectEntity,
          createTimestamp: convertDateTimeFromServer(projectEntity.createTimestamp),
        };
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="freecountApp.project.home.createOrEditLabel" data-cy="ProjectCreateUpdateHeading">
            <Translate contentKey="freecountApp.project.home.createOrEditLabel">Create or edit a Project</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('freecountApp.project.name')}
                id="project-name"
                name="name"
                data-cy="name"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('freecountApp.project.key')}
                id="project-key"
                name="key"
                data-cy="key"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('freecountApp.project.createTimestamp')}
                id="project-createTimestamp"
