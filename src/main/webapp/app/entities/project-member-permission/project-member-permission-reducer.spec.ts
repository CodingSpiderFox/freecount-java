...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './project-member-permission.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROJECTMEMBERPERMISSION_LIST actions', async () => {
    ...
    it('dispatches SEARCH_PROJECTMEMBERPERMISSIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_PROJECTMEMBERPERMISSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PROJECTMEMBERPERMISSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PROJECTMEMBERPERMISSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PROJECTMEMBERPERMISSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PROJECTMEMBERPERMISSION actions', async () => {
      const expectedActions = [
        {
