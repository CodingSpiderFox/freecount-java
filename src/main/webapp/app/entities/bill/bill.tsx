...
export const Bill = (props: RouteComponentProps<{ url: string }>) => {
  ...
  const links = useAppSelector(state => state.bill.links);
  const entity = useAppSelector(state => state.bill.entity);
  ...
  return (
    <div>
      <h2 id="bill-heading" data-cy="BillHeading">
        <Translate contentKey="freecountApp.bill.home.title">Bills</Translate>
        <div className="d-flex justify-content-end">
          <Button className="mr-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="freecountApp.bill.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="freecountApp.bill.home.createLabel">Create new Bill</Translate>
          </Link>
        </div>
      </h2>
      <Row>
            ...
            <FormGroup>
              <InputGroup>
                <Input
                  ...
                  placeholder={translate('freecountApp.bill.home.search')}
                />
          ...
          {billList && billList.length > 0 ? (
              ...
              <thead>
                <tr>
                  <th className="hand" onClick={sort('id')}>
                    <Translate contentKey="freecountApp.bill.id">ID</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
            ...
            !loading && (
              <div className="alert alert-warning">
                <Translate contentKey="freecountApp.bill.home.notFound">No Bills found</Translate>
              </div>
            )
          )}
        </InfiniteScroll>
