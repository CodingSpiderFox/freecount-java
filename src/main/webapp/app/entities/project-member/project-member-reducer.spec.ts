...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROJECTMEMBER_LIST actions', async () => {
    ...
    it('dispatches SEARCH_PROJECTMEMBERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_PROJECTMEMBER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PROJECTMEMBER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PROJECTMEMBER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PROJECTMEMBER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PROJECTMEMBER actions', async () => {
      const expectedActions = [
        {
