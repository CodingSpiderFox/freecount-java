...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROJECTSETTINGS_LIST actions', async () => {
    ...
    it('dispatches SEARCH_PROJECTSETTINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_PROJECTSETTINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PROJECTSETTINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PROJECTSETTINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PROJECTSETTINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PROJECTSETTINGS actions', async () => {
      const expectedActions = [
        {
