...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './project-member-permission-assignment.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROJECTMEMBERPERMISSIONASSIGNMENT_LIST actions', async () => {
    ...
    it('dispatches SEARCH_PROJECTMEMBERPERMISSIONASSIGNMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_PROJECTMEMBERPERMISSIONASSIGNMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PROJECTMEMBERPERMISSIONASSIGNMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PROJECTMEMBERPERMISSIONASSIGNMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PROJECTMEMBERPERMISSIONASSIGNMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PROJECTMEMBERPERMISSIONASSIGNMENT actions', async () => {
      const expectedActions = [
        {
