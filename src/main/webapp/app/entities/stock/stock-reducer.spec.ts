...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STOCK_LIST actions', async () => {
    ...
    it('dispatches SEARCH_STOCKS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_STOCK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_STOCK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_STOCK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_STOCK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_STOCK actions', async () => {
      const expectedActions = [
        {
