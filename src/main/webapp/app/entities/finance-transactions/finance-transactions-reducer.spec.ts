...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './finance-transactions.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FINANCETRANSACTIONS_LIST actions', async () => {
    ...
    it('dispatches SEARCH_FINANCETRANSACTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_FINANCETRANSACTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FINANCETRANSACTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FINANCETRANSACTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FINANCETRANSACTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FINANCETRANSACTIONS actions', async () => {
      const expectedActions = [
        {
